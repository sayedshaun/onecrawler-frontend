...
const sheetVariants = cva(
  "fixed z-50 flex flex-col gap-4 overflow-hidden border-border bg-card p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        right:
